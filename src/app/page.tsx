...
export default function Home() {
  ...
  const handleSend = async () => {
    ...
    try {
      //this executes before the setMessage usestate functions. Get the most up to date message log with current user message
      const updatedMessages = [...messages,userMessage]
      const context = updatedMessages .length > 10 ? updatedMessages.slice(messages.length - 10) : updatedMessages ;
